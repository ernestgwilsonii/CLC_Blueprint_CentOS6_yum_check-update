...
#    Emails a report containing a list of updates available for CentOS6
# Version 1.0 November 15, 2015 ErnestGWilsonII@gmail.com
#         yum_check-update_centos6x.zip
################################################################################
...
# Get a list of available updates via yum check-update
/bin/echo "################################################################################" >> $REPORTFILE
/bin/echo "# List of currently available updates for this OS:" >> $REPORTFILE
/bin/echo "##################################################" >> $REPORTFILE
/usr/bin/yum check-update >> $REPORTFILE
/bin/echo "################################################################################" >> $REPORTFILE
/bin/echo "" >> $REPORTFILE
/bin/echo "" >> $REPORTFILE
...
/bin/cat $LOGFILE | /bin/mailx -s "Blueprint Report: List of available updates for: $THISHOST at $1" -a $REPORTFILE $EMAILREPORTTO